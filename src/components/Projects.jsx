    ...
    <div ref={projectsDivRef} className="bg-light mb-5 py-5">
      <div className="container">
        ...
        <div className="p-3 bg-white rounded shadow">
          <div className="d-flex justify-content-between flex-wrap project-card">
            <a
            ...
            <div className="col-md-5 px-3">
              ...
              <p>
                Obscura Media Limited is a Kenyan based communications firm with
                decades of global experience. Obsura specialize in all aspects
                of media, communications, and public relations including film,
                photography, design, printing, and campaign and communications
                consulting.
              </p>
              <div className="my-2">
          ...
          <div className="d-flex justify-content-between flex-wrap project-card my-5">
            ...
            <div className="col-md-5 px-3">
              ...
              <p>
                Environmental Club offers events and activities of all kinds for
                students interested in breading their horizons, creating amazing
                memories and learning more about environment.
              </p>
              <div className="my-2">
                <i className="fab fa-react fa-lg text-info"></i>
              </div>
