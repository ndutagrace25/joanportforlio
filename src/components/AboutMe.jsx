        ...
        <div className="d-flex justify-content-between flex-wrap">
          <div className="col-md-6">
            ...
            <div className="about-info">
              <p>
                I have a deep passion for my work, fueled by the desire to solve
                problems and create value. I am a self-motivated and self-driven
                individual who is always looking for new challenges and
          ...
          <div className="col-md-6">
            <div className="d-flex justify-content-center px-5 skill-cards">
              <div className="d-flex justify-content-between  col-md-10 flex-wrap">
                ...
                <div className="text-uppercase bg-white shadow rounded p-4 col-md-5 mb-3 d-flex align-items-center skill-card">
                  <i className="fab fa-react fa-2x"></i>
                  <span className="ps-3 fw-bold skill-size ">REACT NATIVE</span>
                </div>
                <div className="text-uppercase bg-white shadow rounded p-4 col-md-5 mb-3 d-flex align-items-center skill-card">
